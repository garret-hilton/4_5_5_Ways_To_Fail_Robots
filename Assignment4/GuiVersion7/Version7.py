...
class GuiTest():
    def __init__(self, r, c=None):
        ...
        self.imgTTS = PhotoImage(file = "tts.gif")
        self.actionString = " "
        ...
        button4.grid(row=7, column=6, rowspan=1,columnspan=2, sticky=N+S+W+E)
        ...
        button9 = tk.Button(self.root, width="10", text="Speach to Text",font=self.font2, bg="blue", fg="yellow", command=self.stt)
        button9.grid(row=6, column=6, rowspan=1,columnspan=1, sticky=N+S+W+E)
        button10 = tk.Button(self.root, width="10", text="Connect",font=self.font2, bg="blue", fg="yellow", command=self.startServer)
        button10.grid(row=6, column=7, rowspan=1,columnspan=1, sticky=N+S+W+E)
        ...
        self.s3 = Scale(self.root, from_=1, to=6, orient=HORIZONTAL, resolution=1, width=30)
        self.label1=tk.Label(self.root, text="Set Time", font=self.font2)
        self.label2=tk.Label(self.root, text="Set PWM", font=self.font2)
        self.label4=tk.Label(self.root, text="Select Test to Speech", font=self.font2)
    ...
    def setQueueLoop(self, message):
        self.queueLoop = message
    ...
    def editQueue(self):
        ...
        self.s4 = Scale(self.t, from_=4000, to=8000, orient=HORIZONTAL, resolution=100, width=30)
    ...
    def showScales(self):
        if   self.buttonID == 0:
            ...
            self.s1 = Scale(self.root, from_=1, to=6, orient=HORIZONTAL, resolution=1, width=30)
    ...
    def drawStuff(self):
        ...
        self.c.create_image(258,307, anchor=NW, image=self.imgTTS)
    ...
    def mousePressed(self, event):
        ...
        elif (event.x > self.x + 248 and event.x < self.x + 393) and (event.y > 307 and event.y < 327):
            self.buttonID = 5
            self.imgID = self.imgTTS
            self.flag1 = True
            self.deltaY1 = event.y - 307
            self.deltaX1 = event.x - 258
            self.actionString = "TTS :"
    ...
    def printSettings(self):
        if self.buttonID == 1:
            ...
            self.c.create_text(328, 125,font=self.font3, text="What do you want to Say?", fill="#777777")
            self.c.create_text(328, 160,font=self.font2, text="1: Hello World", fill="#777777")
            self.c.create_text(328, 180,font=self.font2, text="2: Kill all Humans", fill="#777777")
            self.c.create_text(328, 200,font=self.font2, text="3: Give me an A", fill="#777777")
            self.c.create_text(328, 220,font=self.font2, text="4: I'll Be Back!", fill="#777777")
            self.c.create_text(328, 240,font=self.font2, text="5: Nothing Here", fill="#777777")
            self.c.create_text(328, 260,font=self.font2, text="6: Goodbye!", fill="#777777")
    ...
    def runQueue(self):
        ...
        q1 = Run.Run(queue, size, self.root, self.server)
        try:
