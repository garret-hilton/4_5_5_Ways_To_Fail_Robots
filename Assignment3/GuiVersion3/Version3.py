...
class GuiTest():
    def __init__(self, r, c=None):
        ...
        button4 = tk.Button(self.root, width="15", text="Run",font=self.font2, bg="green3", fg="yellow", command=self.fun)
        ...
        button6 = tk.Button(self.root, width="15", text="Remove",font=self.font2, bg="blue", fg="yellow", command=self.fun)
    ...
    def printSettings(self):
        if self.buttonID == 1:
            ...
            self.c.create_text(380, 150,font=self.font2, text="PWM = 4000 => Full Speed Forward", fill="#777777")
            self.c.create_text(380, 170,font=self.font2, text="PWM = 6000 => Stop:", fill="#777777")
            self.c.create_text(380, 190,font=self.font2, text="PWM = 8000 => Full Speed Backwards", fill="#777777")
            self.c.create_text(380, 210,font=self.font2, text="Time = Time (sec) to Drive forward / backwards", fill="#777777")
        elif self.buttonID == 2:
            self.c.create_text(380, 125,font=self.font3, text="Turn Settings:", fill="#777777")
            self.c.create_text(380, 150,font=self.font2, text="PWM = 4000 => Fast Left Turn", fill="#777777")
            self.c.create_text(380, 170,font=self.font2, text="PWM = 6000 => No Turn:", fill="#777777")
            self.c.create_text(380, 190,font=self.font2, text="PWM = 8000 => Fast Right turn", fill="#777777")
            self.c.create_text(380, 210,font=self.font2, text="Time = Time (sec) to Turn Left / Right", fill="#777777")
        elif self.buttonID == 3:
            self.c.create_text(380, 125,font=self.font3, text="Turn Body Settings:", fill="#777777")
            self.c.create_text(380, 150,font=self.font2, text="PWM = 4000 => Turn Body Far Left", fill="#777777")
            self.c.create_text(380, 170,font=self.font2, text="PWM = 6000 => Face Body Forward", fill="#777777")
            self.c.create_text(380, 190,font=self.font2, text="PWM = 8000 => Turn Body Far Right", fill="#777777")
            self.c.create_text(380, 210,font=self.font2, text="Time = Time (sec) to Turn Body", fill="#777777")
        elif self.buttonID == 4:
            self.c.create_text(380, 125,font=self.font3, text="Turn Head Settings:", fill="#777777")
            self.c.create_text(380, 150,font=self.font2, text="PWM = 4000 => Turn Head Far Left", fill="#777777")
            self.c.create_text(380, 170,font=self.font2, text="PWM = 6000 => Head Face Forward", fill="#777777")
            self.c.create_text(380, 190,font=self.font2, text="PWM = 8000 => Turn Head Far Right", fill="#777777")
            self.c.create_text(380, 210,font=self.font2, text="Time = Time (sec) to Turn Head", fill="#777777")
        elif self.buttonID == 5:
            self.c.create_text(380, 125,font=self.font3, text="Tilt Head Settings:", fill="#777777")
            self.c.create_text(380, 150,font=self.font2, text="PWM = 4000 => Tilt Head far Up", fill="#777777")
            self.c.create_text(380, 170,font=self.font2, text="PWM = 6000 => Tilt Head to Center", fill="#777777")
            self.c.create_text(380, 190,font=self.font2, text="PWM = 8000 => Tilt Head for Down", fill="#777777")
            self.c.create_text(380, 210,font=self.font2, text="Time = Time (sec) to Tilt Head", fill="#777777")
    def arrow(self, key):
        if key.keycode==114:
            self.timeToWait = 5
